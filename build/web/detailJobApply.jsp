                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center"> 
                                <a>Danh sách CV ứng tuyển cho công việc</a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th></th>
                                <th class="text-center">Người ứng tuyển</th>
                        ...
                        <tbody>
                            <c:forEach var="app" items="${applications}">
                                <tr>
                                    <td></td>
                                    <td class="text-center">${app.fullName}</td>
                                    <td class="text-center"><a href="userSaving/CVsave/${app.cvPath}" target="_blank">${app.cvPath}</a></td>
                                    <td class="text-center">${app.statusTitle}</td>
                                    <td class="text-center">${app.appliedAt}</td>
                                    <td class="text-center">
                                        <a href="ApplyManagerServlet?action=applyDetail&applicationID=${app.applicationID}">
