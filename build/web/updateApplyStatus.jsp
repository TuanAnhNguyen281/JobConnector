<%-- 
    Document   : manageCV
    Created on : Nov 8, 2024, 3:05:42 AM
    Author     : ADMIN
--%>
            ...
            <div id="content" class="active">
                <div class="top-navbar">
                    ...
                    <div class="xp-breadcrumbbar text-center">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Quản lý CV</li>
                        </ol>                
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <h2 class="text-center">Chi Tiết Ứng Tuyển</h2>
                    <div class="row">
                        <div class="col-6">
                            <strong>Tên Người Dùng:</strong> ${application.fullName}
                        </div>
                        <div class="col-6">
                            <a href="userSaving/CVsave/${application.cvPath}"> ${application.cvPath}</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <strong>Trạng Thái:</strong> ${application.statusTitle}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p>${application.userDescription}</p>
                            <strong>Tóm Tắt Chuyên Môn</strong> 
                            <p>${application.userProfessionallSummary}</p>
                        </div>
                    </div>

                    <form action="ApplyManagerServlet" method="POST">
                        <input type="hidden" name="applicationID" value="${application.applicationID}">
                        <input type="hidden" name="action" value="updateApply">

                        <div class="row comment-section">
                            <div class="col-12">
                                <strong>Gửi lời nhắn cho ứng viên</strong>
                                <textarea name="comment" class="form-control" rows="4" placeholder="Nhập lời nhắn tại đây..."></textarea>
                            </div>
                        </div>

                        <div class="row btn-container">
                            <button type="submit" name="statusID" value="2" class="btn btn-success btn-block">Đồng Ý</button>
                            <button type="submit" name="statusID" value="3" class="btn btn-danger btn-block">Từ Chối</button>
                        </div>
                    </form>
