                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="main-content">
                                    <div class="breadcrumb">
                                        <span>Trang / Công ty chờ kiểm duyệt</span>
                                        <br>
                                    </div>

                                    <div class="table-container">
                                        <h3>Danh sách các công ty đang chờ kiểm duyệt</h3>

                                        <c:if test="${not empty employerProfilePendingList}">
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th>Tên công ty</th>
                                                ...
                                                <tbody>
                                                    <c:forEach var="company" items="${employerProfilePendingList}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                  <a href="CompanyCheckingServlet?employerID=${company.employerID}" style="text-decoration: none;color:blue"> Kiểm tra </a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                        ...
                                        <c:if test="${empty employerProfilePendingList}">
                                            <p>Không có công ty nào đang chờ được duyệt</p>
                                        </c:if>
                                    </div>
                                </div>
                            </div>
