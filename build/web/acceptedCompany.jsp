                            ...
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center"> 
                                            <a>Công ty thông qua kiểm duyệt</a>
                                        </div>
                                ...
                                <div class="main-content">
                                    <div class="breadcrumb">
                                        <span>Trang / Công ty thông qua kiểm duyệt</span>
                                        <br>
                                    </div>

                                    <div class="table-container">
                                        <h3>Danh sách công ty đã thông qua kiểm duyệt</h3>

                                        <c:if test="${not empty employerProfileAcceptedList}">
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th>Tên công ty</th>
                                                ...
                                                <tbody>
                                                    <c:forEach var="company" items="${employerProfileAcceptedList}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="EmployerProfileDetailsServlet?employerID=${company.employerID}" style="text-decoration: none;color:blue"> Xem chi tiết </a>                                                      
                                                                <br>
                                                                <a href="JobListServlet?userID=${company.userID}" style="text-decoration: none;color:blue">Xem danh sách công việc</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                        ...
                                        <c:if test="${empty employerProfileAcceptedList}">
                                            <p>Chưa có công ty nào được duyệt</p>
                                        </c:if>
                                    </div>
                                </div>
                            </div>
