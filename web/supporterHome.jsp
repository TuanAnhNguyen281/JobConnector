                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="main-content">
                                    <div class="table-container">
                                        <h3>Danh sách phiếu hỗ trợ từ người dùng</h3>
                                                ...
                                                <tbody>
                                                    <c:forEach var="ticket" items="${ticketList}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span style="<c:choose>
                                                                          <c:when test='${ticket.statusID == 1}'>color: orange;</c:when>
                                                                          <c:when test='${ticket.statusID == 2}'>color: green;</c:when>
                                                                          <c:when test='${ticket.statusID == 3}'>color: red;</c:when>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${ticket.statusID == 2}">
                                                                        <a href="SupportServlet?action=viewTicket&ticketID=${ticket.ticketID}" target="_blank">
                                        ...
                                        <c:if test="${empty ticketList}">
                                            <p>Không tìm thấy thông tin hỗ trợ nào.</p>
                                        </c:if>
                                    </div>
                                </div>
                            </div>
