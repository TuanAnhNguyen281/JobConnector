            ...
            <nav id="sidebar" class="active">
                ...
                <ul class="list-unstyled components">
                    <li>
                        ...
                        <a href="aboutus.jsp"><span>Về chúng tôi</span></a>
                        <a href="bussinessRule.jsp"><span>Điều khoản và điều kiện</span>></a>
                    </li>
                </ul>
            </nav>
                                ...
                                <div class="table-title">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                                            <a href="JobManageServlet?action=add" class="btn btn-success">
                                                <i class="material-icons"></i> <span>Thêm tuyển dụng</span></a>
                                        </div>
                                    </div>
                                </div>
                                <table class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Kết quả kiểm duyệt</th>
                                    ...
                                    <c:forEach items="${job}" var="j">
                                        ...
                                        <td></td>
                                        <td class="text-center">${j.jobTitle}</td>
                                        <td class="text-center">${j.locationTitle}</td>
                                        <td class="text-center">${j.endAt}</td>
                                        <td class="text-center">
                                            <c:if test="${not empty Ename}">

                                                <span style="<c:choose>
                                                          <c:when test='${j.statusID == 1}'>color: orange;</c:when>
                                                          <c:when test='${j.statusID == 2}'>color: green;</c:when>
                                                          <c:when test='${j.statusID == 3}'>color: red;</c:when>
                                                          <c:otherwise></c:otherwise>
                                                      </c:choose>">
                                                    ${j.statusTitle}
                                                </c:if>
                                        ...
                                        <td class="action-links text-center">
                                            <a class="btn" href="JobManageServlet?action=edit&jobid=${j.jobID}">Chỉnh sửa</a>
                                            <a class="btn" href="JobManageServlet?action=viewdelete&jobid=${j.jobID}">Xóa</a>
                                        </td>
                                        <td></td>
